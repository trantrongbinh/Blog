                    ...
                    <div>
                        <div class="box-tabs">
                            <ul class="nav nav-pills">
                                <li class="nav-item"><a class="nav-link active btn-outline-info" href="#activity" data-toggle="tab">Posts</a></li>
                                <li class="nav-item"><a class="nav-link btn-outline-info" href="#question" data-toggle="tab">Questions</a></li>
                            </ul>
                        ...
                        <div class="container-fluid">
                            <div class="tab-content">
                                ...
                                <!-- /.tab-pane -->
                                <div class="tab-pane" id="question" style="background: #fff; min-height: 700px;">
                                    <!-- The timeline -->
                                    <ul class="timeline timeline-inverse">
                                        ...
                                        <li>
                                            ...
                                            <div class="timeline-item">
                                                <span class="time"><i class="fa fa-thumb-tack"></i></span>
                                                <h3 class="timeline-header"><a href="#">About TTB</a> Slogan</h3>
                                                <div class="timeline-body">
                                                    "Thất bại không phải là ngõ cụt ! Thất bại là khi động lực không còn. Ngã ở đâu đứng lên ở đó rồi một ngày chúng ta sẽ thành công !"
                                                </div>
                                            </div>
                                        </li>
                                        <!-- END timeline item -->
                                        ...
                                        <li>
                                            ...
                                            <div class="timeline-item">
                                                <span class="time"><i class="fa fa-users"></i> </span>
                                                <h3 class="timeline-header no-border"><a href="#">BKFA Team</a> </h3>
                                            </div>
                                        </li>
                                        <!-- END timeline item -->
                                        <!-- timeline item -->
                                        <li>
                                            ...
                                            <div class="timeline-item">
                                                <span class="time"><i class="fa fa-heart"></i> </span>
                                                <h3 class="timeline-header"><a href="#">Th-ng</a> =))</h3>
                                                <div class="timeline-body">
                                        ...
                                        <!-- END timeline item -->
                                        <li>
                                            <i class="fa fa-clock-o bg-gray" style="margin-top: -40px;"></i>
                                        </li>
                                    </ul>
                                </div>
                                <!-- /.tab-pane -->
